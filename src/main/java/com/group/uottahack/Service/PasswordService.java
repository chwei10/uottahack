...
public class PasswordService {
    ...
    public Password generate(int passwordLength, boolean num, boolean cap, boolean sym) {
        Password password = new Password();
        password.setPassword(generateCommonLangPassword(passwordLength,num, cap, sym));
//        password.setPassword(RandomStringUtils.random(passwordLength, true, true));
        return password;
    }
